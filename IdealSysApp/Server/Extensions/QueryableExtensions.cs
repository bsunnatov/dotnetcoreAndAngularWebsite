...
namespace IdealSysApp.Extensions
{
  public static class QueryableExtensions
  {
    ...
    public static IQueryable<T> ForDataSourceResult<T>(this IQueryable<T> queryable, int take, int skip, IEnumerable<Sort> sort, Filter filter)
    {
      // Filter the data first
      queryable = Filter(queryable, filter);
