...
namespace IdealSysApp.Migrations
{
    ...
    [Migration("20171004142933_Adding_Customer")]
    partial class Adding_Customer
    {
        protected override void BuildTargetModel(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity("IdealSysApp.Models.Entities.Order", b =>
                {
                    ...
                    b.Property<string>("OverheadNumber");
            ...
            modelBuilder.Entity("IdealSysApp.Server.Entities.Customer", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("IdealSysApp.Models.Entities.Order", b =>
                {
                    b.HasOne("IdealSysApp.Server.Entities.Customer", "Customer")
                        .WithMany("Orders")
